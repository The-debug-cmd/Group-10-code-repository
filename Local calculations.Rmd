...
Gtestinhom1 = envelope(finpersontheftppp, fun = Ginhom, nsim = 10000)
Gtestinhom2 = envelope(finotherthiefppp, fun = Ginhom, nsim = 10000)
plot(Gtestinhom1, xlab = "Distance in meters", main = "", legend = "", xlim = c(0,20))
plot(Gtestinhom2, xlab = "Distance in meters", main = "", legend = "", xlim = c(0,20))
#madgtestinhom = mad.test(finpersontheftppp, fun = Ginhom, nsim = 10000)
#madgtestinhom1 = mad.test(finotherthiefppp, fun = Ginhom, nsim = 10000)
```
